                ...
                <div class="p-6 bg-white border-b border-gray-200 flex justify-between">
                    <form method="post" class="w-full ml-5" action="{{ route('operator.item.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="price" class="block mt-1 w-full" type="number" name="price" placeholder="Harga awal barang" :value="old('price')"  />
                        ...
                        <div class="mt-4">
                            ...
                            <input type="file" name="pics[]" id="pics" required accept="image/png, image/jpeg, image/gif" 
                            multiple 
